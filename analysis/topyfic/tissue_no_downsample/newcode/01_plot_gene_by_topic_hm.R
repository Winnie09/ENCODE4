at = list.files('/home/whou10/scratch4/whou10/encode4/topyfic/tissue_no_downsample/res/')
at = setdiff(at, 'Homo_sapiens:right_cardiac_atrium')
for (t in at){
  print(t)
  setwd(paste0('/home/whou10/scratch4/whou10/encode4/topyfic/tissue_no_downsample/res/', t, '/figures'))
