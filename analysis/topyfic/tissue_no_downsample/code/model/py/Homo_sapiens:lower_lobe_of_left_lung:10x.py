...
os.mkdir('/home/whou10/scratch4/whou10/encode4/topyfic/tissue_no_downsample/res/Homo_sapiens:lower_lobe_of_left_lung:10x')
os.chdir('/home/whou10/scratch4/whou10/encode4/topyfic/tissue_no_downsample/res/Homo_sapiens:lower_lobe_of_left_lung:10x')

ENCSR753YPW=Topyfic.read_train("/home/whou10/scratch4/whou10/encode4/topyfic/train_no_downsample/res/ENCSR753YPW.p")
...
data = sc.read('/home/whou10/scratch4/whou10/encode4/data/scrna/anndata/h5ad_tissue_no_downsample/Homo_sapiens:lower_lobe_of_left_lung:10x.h5ad')
