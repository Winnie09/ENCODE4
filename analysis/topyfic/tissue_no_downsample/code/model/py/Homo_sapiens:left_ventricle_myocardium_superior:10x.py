...
os.mkdir('/home/whou10/scratch4/whou10/encode4/topyfic/tissue_no_downsample/res/Homo_sapiens:left_ventricle_myocardium_superior:10x')
os.chdir('/home/whou10/scratch4/whou10/encode4/topyfic/tissue_no_downsample/res/Homo_sapiens:left_ventricle_myocardium_superior:10x')

ENCSR079LVG=Topyfic.read_train("/home/whou10/scratch4/whou10/encode4/topyfic/train_no_downsample/res/ENCSR079LVG.p")
...
data = sc.read('/home/whou10/scratch4/whou10/encode4/data/scrna/anndata/h5ad_tissue_no_downsample/Homo_sapiens:left_ventricle_myocardium_superior:10x.h5ad')
