...
os.mkdir('/home/whou10/scratch4/whou10/encode4/topyfic/tissue_no_downsample/res/Homo_sapiens:Right_ventricle_myocardium_superior:10x')
os.chdir('/home/whou10/scratch4/whou10/encode4/topyfic/tissue_no_downsample/res/Homo_sapiens:Right_ventricle_myocardium_superior:10x')

ENCSR813PWQ=Topyfic.read_train("/home/whou10/scratch4/whou10/encode4/topyfic/train_no_downsample/res/ENCSR813PWQ.p")
...
data = sc.read('/home/whou10/scratch4/whou10/encode4/data/scrna/anndata/h5ad_tissue_no_downsample/Homo_sapiens:Right_ventricle_myocardium_superior:10x.h5ad')
data.X = normalization(data.X)
data.X = np.round_(data.X)
    
top_model, clustering, adata = Topyfic.calculate_leiden_clustering(trains=[ENCSR813PWQ], data=data)
