...
data = sc.read('/home/whou10/scratch4/whou10/encode4/data/scrna/anndata/h5ad_sample_mouseag/'+sys.argv[1]+'.h5ad')
...
train.save_train('/home/whou10/scratch4/whou10/encode4/topyfic/train/'+sys.argv[1])
