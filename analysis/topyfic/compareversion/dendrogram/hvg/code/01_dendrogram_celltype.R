...
for (tissue in alltissue){
  ddir <- paste0('/home/whou10/scratch4/whou10/encode4/topyfic/tissue_hvg/res/', tissue, '/figures/')
  pdir <- '/home/whou10/scratch4/whou10/encode4/topyfic/compareversion/dendrogram/hvg/plot/'
  rdir <- '/home/whou10/scratch4/whou10/encode4/topyfic/compareversion/dendrogram/hvg/res/'
  tb3 = read.csv(paste0(ddir, 'cell_participation.csv'), row.names = 1)

  pc = PCA(genebycellmat = t(tb3), maxVariableGenes = ncol(tb3), numPC = 3)
  d = as.matrix(dist(pc))
