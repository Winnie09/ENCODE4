...
os.mkdir('/home/whou10/scratch4/whou10/encode4/topyfic/tissue/res/Homo_sapiens:Right_ventricle_myocardium_inferior')
os.chdir('/home/whou10/scratch4/whou10/encode4/topyfic/tissue/res/Homo_sapiens:Right_ventricle_myocardium_inferior')

ENCSR151ONW=Topyfic.read_train("/home/whou10/scratch4/whou10/encode4/topyfic/train/res/ENCSR151ONW.p")
...
data = sc.read('/home/whou10/scratch4/whou10/encode4/data/scrna/anndata/h5ad_tissue/Homo_sapiens:Right_ventricle_myocardium_inferior.h5ad')
