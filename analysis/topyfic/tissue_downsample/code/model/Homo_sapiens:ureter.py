...
os.mkdir('/home/whou10/scratch4/whou10/encode4/topyfic/tissue/res/Homo_sapiens:ureter')
os.chdir('/home/whou10/scratch4/whou10/encode4/topyfic/tissue/res/Homo_sapiens:ureter')

ENCSR964JZN=Topyfic.read_train("/home/whou10/scratch4/whou10/encode4/topyfic/train/res/ENCSR964JZN.p")
...
data = sc.read('/home/whou10/scratch4/whou10/encode4/data/scrna/anndata/h5ad_tissue/Homo_sapiens:ureter.h5ad')
