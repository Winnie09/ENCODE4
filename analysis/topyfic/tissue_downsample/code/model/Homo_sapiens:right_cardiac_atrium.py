...
os.mkdir('/home/whou10/scratch4/whou10/encode4/topyfic/tissue/res/Homo_sapiens:right_cardiac_atrium')
os.chdir('/home/whou10/scratch4/whou10/encode4/topyfic/tissue/res/Homo_sapiens:right_cardiac_atrium')

ENCSR522HNR=Topyfic.read_train("/home/whou10/scratch4/whou10/encode4/topyfic/train/res/ENCSR522HNR.p")
ENCSR943HBF=Topyfic.read_train("/home/whou10/scratch4/whou10/encode4/topyfic/train/res/ENCSR943HBF.p")
ENCSR087YKG=Topyfic.read_train("/home/whou10/scratch4/whou10/encode4/topyfic/train/res/ENCSR087YKG.p")
...
data = sc.read('/home/whou10/scratch4/whou10/encode4/data/scrna/anndata/h5ad_tissue/Homo_sapiens:right_cardiac_atrium.h5ad')
