...
os.mkdir('/home/whou10/scratch4/whou10/encode4/topyfic/tissue/res/Homo_sapiens:lower_lobe_of_left_lung')
os.chdir('/home/whou10/scratch4/whou10/encode4/topyfic/tissue/res/Homo_sapiens:lower_lobe_of_left_lung')

ENCSR753YPW=Topyfic.read_train("/home/whou10/scratch4/whou10/encode4/topyfic/train/res/ENCSR753YPW.p")
...
data = sc.read('/home/whou10/scratch4/whou10/encode4/data/scrna/anndata/h5ad_tissue/Homo_sapiens:lower_lobe_of_left_lung.h5ad')
