...
os.mkdir('/home/whou10/scratch4/whou10/encode4/topyfic/tissue/res/Homo_sapiens:colonic_mucosa')
os.chdir('/home/whou10/scratch4/whou10/encode4/topyfic/tissue/res/Homo_sapiens:colonic_mucosa')

ENCSR656VWP=Topyfic.read_train("/home/whou10/scratch4/whou10/encode4/topyfic/train/res/ENCSR656VWP.p")
ENCSR707ECV=Topyfic.read_train("/home/whou10/scratch4/whou10/encode4/topyfic/train/res/ENCSR707ECV.p")
...
data = sc.read('/home/whou10/scratch4/whou10/encode4/data/scrna/anndata/h5ad_tissue/Homo_sapiens:colonic_mucosa.h5ad')
