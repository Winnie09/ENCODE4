...
os.mkdir('/home/whou10/scratch4/whou10/encode4/topyfic/tissue_pseudobulk/' + sys.argv[1])
os.chdir('/home/whou10/scratch4/whou10/encode4/topyfic/tissue_pseudobulk/' + sys.argv[1])


d=Topyfic.read_train("/home/whou10/scratch4/whou10/encode4/topyfic/train_pseudobulk/" + sys.argv[1] + ".p")

data = sc.read('/home/whou10/scratch4/whou10/encode4/data/scrna/anndata/pseudobulk/' + sys.argv[1] + '.h5ad')
data.X = np.round_(data.X)

top_model, clustering, adata = Topyfic.calculate_leiden_clustering(trains=[d], data=data)
