...
pdir <- '/home/whou10/scratch4/whou10/encode4/pseudobulk_umap/snrna/pb/plot/human/'
rdir <- '/home/whou10/scratch4/whou10/encode4/pseudobulk_umap/snrna/pb/result/human/'
pd <- readRDS('/home/whou10/scratch4/whou10/encode4/data/pseudobulk/snrna/pb/Homo_sapiens_pb.rds')  #  [1:58780, 1:1190]
...
summary(num_cell)
hist(log10(num_cell))
pd <- pd[, num_cell > 50] # [1:58780, 1:652]
## pd <- pd[rowMeans(pd > mean(apply(pd, 1, median))) > 0.1, ] ## [1:26561, 1:350]
pd <- pd[rowMeans(pd > median(pd[pd > 0])) > 0.1, ] ##  [1:17785, 1:652]
str(pd)
