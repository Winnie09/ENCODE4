...
pdir <- '/home/whou10/scratch4/whou10/encode4/pseudobulk_umap/snrna/pb_mouse/plot/'
rdir <- '/home/whou10/scratch4/whou10/encode4/pseudobulk_umap/snrna/pb_mouse/result/'
dir.create(pdir, recursive = T, showWarnings = F)
dir.create(rdir, recursive = T, showWarnings = F)
#pd <- readRDS('/home/whou10/scratch4/whou10/encode4/data/pseudobulk/snrna/pb/mouse.rds')  
pd <- readRDS('/home/whou10/data/zji/encode/data/scrna/pb/mouse.rds')
str(pd)
colnames(pd)[1]
...
## ------------------------------------
## ad hoc: remove pseudobulks with NAs
## ------------------------------------
id.rm <- which(is.na(colMeans(pd)))
str(id.rm)
pd <- pd[, -id.rm]
...
u = cbind(u, tissue_short = sub(' Tissue.*', '', sub('.*B6CASTF1/J ', '', u[, 3])))
