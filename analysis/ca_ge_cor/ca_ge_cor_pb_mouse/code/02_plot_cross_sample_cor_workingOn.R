...
pdir <- '/home/whou10/scratch4/whou10/encode4/ca_ge_cor_pb_mouse/plot/'
rdir <- '/home/whou10/scratch4/whou10/encode4/ca_ge_cor_pb_mouse/result/'
pd <- readRDS(paste0(ddir, 'mouse_acrosssample.rds'))
str(pd) 
