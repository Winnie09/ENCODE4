...
os.mkdir('/home/zji4/data-hji7/zji/encode/data/scrna/topyfic/tissue/res/Homo_sapiens:left_cardiac_atrium')
os.chdir('/home/zji4/data-hji7/zji/encode/data/scrna/topyfic/tissue/res/Homo_sapiens:left_cardiac_atrium')

ENCSR527MGL=Topyfic.read_train("/home/zji4/data-hji7/zji/encode/data/scrna/topyfic/train/res/ENCSR527MGL.p")
ENCSR463EEP=Topyfic.read_train("/home/zji4/data-hji7/zji/encode/data/scrna/topyfic/train/res/ENCSR463EEP.p")
ENCSR700UVN=Topyfic.read_train("/home/zji4/data-hji7/zji/encode/data/scrna/topyfic/train/res/ENCSR700UVN.p")
...
data = sc.read('/home/zji4/data-hji7/zji/encode/data/scrna/anndata/h5ad_tissue/Homo_sapiens:left_cardiac_atrium.h5ad')
