...
pdir <- '/home/whou10/scratch4/whou10/encode4/pseudobulk_umap/snatac/pb_human_noFilterPb/plot/'
rdir <- '/home/whou10/scratch4/whou10/encode4/pseudobulk_umap/snatac/pb_human_noFilterPb/result/'
...
for (colid in 3:ncol(u)) {
  ...
  pdf(
    ...
    width = max(2.8 * length(unique(u[,colid]))/7, 4),
    height = 2
  )
  print(
    ggplot(data = u) +
