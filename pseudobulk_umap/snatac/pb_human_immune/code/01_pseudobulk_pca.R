rm(list=ls())
## ------------------------------------------
## do snATAC pseudobuk PCA using immune cells
## ------------------------------------------
## read in pseudobulk
source('/home/whou10/scratch16/whou10/resource/myfunc/01_function.R')
pdir <- '/home/whou10/scratch4/whou10/encode4/pseudobulk_umap/snatac/pb_human_immune/plot/'
rdir <- '/home/whou10/scratch4/whou10/encode4/pseudobulk_umap/snatac/pb_human_immune/result/'
rdir2 <- '/home/whou10/scratch4/whou10/encode4/pseudobulk_umap/snatac/pb_human/result/'
...
meta <- readRDS(paste0(rdir2, 'umap_and_cell_meta.rds'))
str(meta)
table(meta[,4])
## ---------------------------------------
## subset immune cells for downstream PCA
## ---------------------------------------
selcell <- rownames(meta)[grep(('(Immune)|(B\\()|(Lymphatic)|(Lymphoid)|(T\\()|(Macrophage)|(Myeloid)|(_macrophage)') , meta[,4])]
table(meta[selcell,4])
pd <- pd[, selcell]
str(pd) ## [1:58721, 1:34] 
